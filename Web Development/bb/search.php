...
$sql = "SELECT * FROM donors WHERE Donor_ID = $id_d ";
...
echo "<td id='action'>";
echo "<a href='update.php?id=".$row['Donor_ID'] ."' ><i class='fas fa-edit'></i></a>&nbsp;&nbsp;";
echo "<a href='delete.php?id=".$row['Donor_ID'] ."' ><i class='fas fa-trash'></i></a>";
echo "</td>";
echo "</tr>";
}
echo "</tbody>";
